...
- realizzazione di un proxy {\em simplex} e {\em full-duplex} ad alta affidabilità}
...
\cvitem{luglio 2014 - maggio 2015}{\textbf{IT Consultant}\newline ALTEN Italia presso UniCredit}
...
\cvitem{\textbf{Inglese}}{Scritto: ottimo\newline Parlato: buono}

\section{Conoscenze Informatiche}
\cvitem{\textbf{Linguaggi conosciuti}}{C\newline C++ (+ boost)\newline Java (+ android, libgdx, gwt, struts2)\newline Python\newline Bash\newline HTML5\newline CSS3 (+ SASS, LESS)\newline Javascript (+ nodejs, angular, jquery)\newline SQL\newline \LaTeX (+ tikz)}
\cvitem{\textbf{Competenze acquisite}}{Amministrazione di sistemi GNU/Linux\newline Configurazione di servers PostgreSQL\newline Familiarità con terminali Bash\newline Sviluppo web con architettura REST\newline Sviluppo applicazioni mobili per Android con API native oppure con LibGDX\newline Sviluppo software in C secondo standard ANSI/POSIX\newline Analisi, progettazione ed implementazione di applicativi web\newline Task Automation\newline Continous Integration\newline Test Driven Development}
